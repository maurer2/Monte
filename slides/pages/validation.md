...
* It is currently not possible to define a non-optional object key that can be `undefined`, without using a workaround ([link to issue](https://github.com/colinhacks/zod/issues/2464))
